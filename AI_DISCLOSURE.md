...
- Role: local-only deterministic rewrite in the next-20 autonomous sprint
- Review model: AI-assisted drafting with manual review required before publication
- Provenance model: imported Rust history retained; deterministic runtime content is derivative and traceable
...
- Missing live-provider features must fail fast and be recorded in `GAPS.md`
